...
<body>
		...
		<div class="collapse navbar-collapse navbar-ex1-collapse">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown headerText"><a href="#"
					...
					<ul class="dropdown-menu">
						<li><a
							href="${pageContext.request.contextPath}/victoria-2004">Вікторія
								- 2004</a></li>
						<li><a
							href="${pageContext.request.contextPath}/victoria-2009">Вікторія
								- 2009</a></li>
	...
	<footer class="footer text-center">
		<div>© ФК Вікторія. Всі права захищено. 2017 - 2018.</div>
		<div>
			Створення сайту і розробка сайтів - Веб-студія <a
				href="https://www.facebook.com/jevgen.volynets"> "PeppaLand"</a>
		</div>
	</footer>
